...
const Alert = ({ errors }) => {
  return (
    <div className="flex items-start justify-between max-w-80 w-full bg-red-600/20 text-red-600 p-2 min-h-10 rounded-sm">
      <div className="flex items-start grow pr-2">
        <svg
          width="20"
          height="20"
          viewBox="0 0 20 20"
        ...
        <p className="text-sm ml-2 wrap-break-word whitespace-normal">
          {errors}
        </p>
      </div>
      <button
